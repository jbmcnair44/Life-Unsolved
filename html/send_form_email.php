...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["name"])) {
    ...
    if (!preg_match("/^[a-zA-Z ]*$/",$name)) {
     exit("<h3>Oops! Something went wrong. Try going back and checking your name. Only letters and spaces are allowed.<br><br> If the Problem continues feel free to email us at lifeunsolved@gmail.com</h3>")
    ;
  ...
  if (empty($_POST["email"])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
           exit("<h3>Oops! Something went wrong. It looks like your email address isn't valid. Try going back and resubmiting the form.<br><br> If the Problem continues feel free to email us at lifeunsolved@gmail.com</h3>");
    }
  }
